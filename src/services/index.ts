...
export const reportsService = {
  ...
  excelEstoqueNissan: () =>
    api.get('/reports/excel/estoque-nissan', { responseType: 'blob' }).then((r) => r.data),
  excelEstoque: () =>
  ...
  excelMovimentacao: (params?: any) =>
    api.get('/reports/excel/movimentacao', { params, responseType: 'blob' }).then((r) => r.data),
